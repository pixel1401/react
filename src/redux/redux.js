...
export const addPost = ()=> {
    let newPostt = {
        name:"Function",
        likeCount:0,
        text:dataBase.profileComponent.newText,
    };

    dataBase.profileComponent.postsBase.push(newPostt);
    dataBase.profileComponent.newText = "";
    renderDom(dataBase )
}


export const updateNewTextPost = (text)=> {
    dataBase.profileComponent.newText = text;
    renderDom(dataBase);
}
